...
| família | o que cobre | severidade |
| --- | --- | --- |
| **Justificativa** `J1` `J2` `J3` | escape de tipo, TODO e catch precisam do porquê **na linha** | violação |
| **Testes** `T1` `T2` `T3` | teste sem asserção, asserção que não falha, skip sem motivo | violação |
